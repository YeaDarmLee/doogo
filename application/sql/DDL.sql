...
CREATE TABLE `USER_LIST` (
  ...
  `PHONE` varchar(50) DEFAULT NULL COMMENT '사용자 연락처',
  `TYPE_CODE` varchar(50) DEFAULT NULL COMMENT '사용자 타입 코드',
  `STATUS_CODE` varchar(50) DEFAULT NULL COMMENT '사용자 상태 코드',
  `REFRESH_TOKEN` varchar(255) DEFAULT NULL COMMENT '사용자 RefreshToken',
  `CREATED_AT` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '생성 일시',
  `UPDATED_AT` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '수정 일시',
  PRIMARY KEY (`SEQ`),
  UNIQUE KEY `USER_ID` (`USER_ID`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='사용자 목록 테이블';